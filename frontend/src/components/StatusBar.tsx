...
export default function StatusBar() {
  ...
  return (
    <div className="pointer-events-none absolute bottom-4 left-4 z-10 flex items-center gap-3 rounded-md bg-slate-900/80 px-3 py-2 text-sm text-slate-100 shadow-lg backdrop-blur">
